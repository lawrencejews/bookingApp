        ...
        <div>
          <form>
            ...
            <p className="text-gray-500 text-sm">
              Title for your place with as stated in the advertisement
            </p>
            <input type="text" placeholder="My lovely Apartment" />
            <h2 className="text-2xl mt-4">Address</h2>
            <p className="text-gray-500 text-sm">Address to this place</p>
            <input type="text" placeholder="address" />
            <h2 className="text-2xl mt-4">Photos</h2>
            <p className="text-gray-500 text-sm">Much better</p>
            ...
            <p className="text-gray-500 text-sm">
              Add check in and out, remember to have time window for cleaning
              the room
            </p>
